...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "currencymonitoring" because\n';
  ...
  $wnd.__gwt_activeModules['currencymonitoring'] = {
    'moduleName' : 'currencymonitoring',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/currencymonitoring.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['currencymonitoring'].superdevmode = true;

  var expectedSuffix = '/currencymonitoring.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + currencymonitoring + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:currencymonitoring';
  var devModeSessionKey = '__gwtDevModeSession:currencymonitoring';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/currencymonitoring/currencymonitoring.nocache.js';
  ...
  $wnd.__gwt_activeModules['currencymonitoring'].canRedirect = true;
  $wnd.__gwt_activeModules['currencymonitoring'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING currencymonitoring';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/currencymonitoring?user.agent=' + ua + '&_callback=' + callback;
